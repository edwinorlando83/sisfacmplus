...
import ec.gob.sri.comprobantes.modelo.liquidacioncompra.LiquidacionCompras;
  ...
  public class LiquidacionComprasReporte
  {
    private LiquidacionCompras liquidacioncompra;
    ...
    public LiquidacionComprasReporte(LiquidacionCompras liquidacioncompra)
    {
/*  25 */     this.liquidacioncompra = liquidacioncompra;
    }
  
    public LiquidacionCompras getFactura()
    {
/*  32 */     return this.liquidacioncompra;
    }
  
    public void setFactura(LiquidacionCompras factura)
    {
/*  39 */     this.liquidacioncompra = factura;
    }
...
/*  90 */     for (LiquidacionCompras.Detalles.Detalle det : getFactura().getDetalles().getDetalle()) {
...
/* 103 */         for (LiquidacionCompras.Detalles.Detalle.DetallesAdicionales.DetAdicional detAdicional : det.getDetallesAdicionales().getDetAdicional()) {
/* 104 */           if (i == 0) {
...
/* 127 */     this.detallesAdiciones = detallesAdiciones;
    ...
    public List<InformacionAdicional> getInfoAdicional()
    {
      ...
      if (getFactura().getInfoAdicional() != null) {
       ...
       if ((getFactura().getInfoAdicional().getCampoAdicional() != null) && (!this.liquidacioncompra.getInfoAdicional().getCampoAdicional().isEmpty())) {
         for (LiquidacionCompras.InfoAdicional.CampoAdicional ca : getFactura().getInfoAdicional().getCampoAdicional()) {
