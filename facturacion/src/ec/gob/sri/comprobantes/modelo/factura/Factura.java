...
public class Factura {
	...
	public String getIvaPorcentaje() {
		...
		for (TotalImpuesto totalimpuesto : getInfoFactura().getTotalConImpuestos().getTotalImpuesto()) {
	...
	@XmlType(name = "", propOrder = { "fechaEmision", "dirEstablecimiento", "contribuyenteEspecial",
			...
			"identificacionComprador", "totalSinImpuestos", "totalSubsidio","totalDescuento", "totalConImpuestos", "propina",
			"importeTotal", "moneda" ,"pagos","direccionComprador"})
	public static class InfoFactura {
		...
		public String getTipoIdentificacionComprador() {
			/* 1377 */ return this.tipoIdentificacionComprador;
		}

		public void setTipoIdentificacionComprador(String value) {
			/* 1389 */ this.tipoIdentificacionComprador = value;
		}
		...
		public String getRazonSocialComprador() {
			/* 1425 */ return this.razonSocialComprador;
		}

		public void setRazonSocialComprador(String value) {
			/* 1437 */ this.razonSocialComprador = value;
		}

		public String getIdentificacionComprador() {
			/* 1449 */ return this.identificacionComprador;
		}

		public void setIdentificacionComprador(String value) {
			/* 1461 */ this.identificacionComprador = value;
		}
